...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
        <div class="container px-5">
            <a class="navbar-brand fw-bold" href="#page-top"><?= $pengaturan->web['nama'] ?></a>
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        <h1 class="display-1 lh-1 mb-3"><?= $pengaturan->web['nama'] ?></h1>
                        <p class="lead fw-normal text-muted mb-5"><?= $pengaturan->web['deskripsi'] ?></p>
                            ...
                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="screen bg-black">
                                    ...
                                    <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%">
                                        <source
                                            src="template/<?= $pengaturan->web['template'] ?>/assets/img/demo-screen.mp4"
                                            type="video/mp4" />
                                    </video>
                                </div>
                            </div>
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    ...
                    <img src="<?= base_url('template/newage/assets/img/tnw-logo.svg') ?>" alt="..."
                        style="height: 3rem" />
                </div>
            </div>
        </div>
    ...
    <footer class="bg-black text-center py-5">
        <div class="container px-5">
            <div class="text-white-50 small">
                <div class="mb-2"><?= $pengaturan->web['footer'] ?></div>
                <a href="#!">Privacy</a>
